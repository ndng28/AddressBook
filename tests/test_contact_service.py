...
class TestGetContact:
    ...
    def test_get_contact_success(self, db_session: Session, test_user: User, test_contact: Contact):
    ...
    def test_get_contacts_list(self, db_session: Session, test_user: User, test_contact: Contact):
    ...
    def test_get_contacts_excludes_deleted(self, db_session: Session, test_user: User, test_contact: Contact):
...
class TestUpdateContact:
    ...
    def test_update_contact_success(self, db_session: Session, test_user: User, test_contact: Contact):
...
class TestDeleteContact:
    ...
    def test_delete_contact_success(self, db_session: Session, test_user: User, test_contact: Contact):
    ...
    def test_restore_contact_success(self, db_session: Session, test_user: User, test_contact: Contact):
